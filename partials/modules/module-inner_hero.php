...
<section class="inner-hero-bottom-section bg-aqua-light lg:pt-[100px] lg:pb-[140px] pt-[215px] pb-[90px] relative after:absolute after:w-full md:after:h-[140px] after:h-[76px] after:rounded-full after:bg-[url(../assets/images/white-circle.svg)] md:after:bottom-[-84px] after:bottom-[-46px] after:bg-repeat md:after:bg-[140px,140px] after:bg-[76px,76px]">
  <div class="container">
